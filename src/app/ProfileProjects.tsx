...
function ProjectItem({
  ...
  return (
    <a 
      href={url} 
      className="flex items-center justify-between p-2 border-2 rounded-full border-[#00aff0] bg-white text-[#00aff0] text-[14px] w-full md:w-full hover:w-full hover:bg-[#00aff0] hover:text-white transition-all duration-200" 
      target="_blank"
    ...
    <div className="bg-white p-4 space-y-16">
      <div className="flex flex-col space-y-16">
        ...
        <div className="flex flex-col items-center w-full">
          ...
          <div className="flex justify-center space-y-3 w-full">
