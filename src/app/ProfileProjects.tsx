    ...
    <div className="bg-white p-4 space-y-16">
      <div className="flex flex-col md:flex-row md:space-x-8 space-y-8 md:space-y-0">
        ...
        <div className="w-full md:w-1/2 transform transition-transform duration-300 hover:scale-105">
          <div className="p-4 border-2 border-[#00aff0] bg-white">
        ...
        <div className="w-full md:w-1/2 space-y-8">
          {/* Shopee */}
          <div className="transform transition-transform duration-300 hover:scale-105 p-4 border-2 border-[#00aff0] bg-white">
            <div className="flex items-center mb-4">
              <img
