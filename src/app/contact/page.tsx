    ...
    <AppLayout hideContact={true}>
      <div className={'flex flex-col md:flex-row md:h-full'}>
        ...
        >
          ...
          />
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white/90 to-transparent h-full w-full text-black p-4 z-10">
            <div className={'absolute bottom-0 left-0 right-0 p-8 flex flex-col items-center'}>
              ...
              <a
                href={'https://www.zalo.me/0387654443'}
            ...
            <div className={'flex flex-row items-start gap-4 mt-2'}>
              {AppConfig.socialLinks.map((link, index) => (
                <a
                  ...
                  href={link.url}
                  target={'_blank'}
                  className={'flex flex-row gap-1 items-center bg-neutral-100 px-4 py-2 rounded-full text-neutral-800 transition-all cursor-pointer duration-300 hover:bg-primary hover:text-white hover:shadow-lg'}
                >
                  <link.icon className={''} />
                  {link.name}
                </a>
